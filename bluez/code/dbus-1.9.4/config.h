...
#define DBUS_BINDIR "/disk4/liangshen/practice/bluez_outdir/bin"
...
#define DBUS_DAEMONDIR "/disk4/liangshen/practice/bluez_outdir/bin"

/* Name of executable */
#define DBUS_DAEMON_NAME "dbus-daemon"

/* Directory for installing DBUS data files */
#define DBUS_DATADIR "/disk4/liangshen/practice/bluez_outdir/share"
...
#define DBUS_LIBEXECDIR "/disk4/liangshen/practice/bluez_outdir/libexec"

/* Prefix for installing DBUS */
#define DBUS_PREFIX "/disk4/liangshen/practice/bluez_outdir"
...
#define DBUS_SYSTEM_BUS_DEFAULT_ADDRESS "unix:path=/disk4/liangshen/practice/bluez_outdir/var/run/dbus/system_bus_socket"

/* The name of the socket the system bus listens on by default */
#define DBUS_SYSTEM_SOCKET "/disk4/liangshen/practice/bluez_outdir/var/run/dbus/system_bus_socket"

/* Full path to the daemon in the builddir */
#define DBUS_TEST_EXEC "/disk4/liangshen/practice/bluetooth_arm/code/dbus-1.9.4/test"

/* Full path to the launch helper test program in the builddir */
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/disk4/liangshen/practice/bluetooth_arm/code/dbus-1.9.4/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.9.4"
...
#define TEST_BUS_LAUNCH_BINARY "/disk4/liangshen/practice/bluetooth_arm/code/dbus-1.9.4/tools/dbus-launch"
